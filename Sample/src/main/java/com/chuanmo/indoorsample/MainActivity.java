...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InDoorView inDoorView = (InDoorView) findViewById(R.id.surface);
        ...
        inDoorView.setAdapter(adapter);//初始化
...
/*
        ...
        //如果路径复杂,在计算边界的时候会导致JNI Crash, 需要注意, 可以通过一开始设置大的裁剪区来避免 http://stackoverflow
        .com/questions/12892711/compute-bounds-of-a-path-crash/12932179#12932179
